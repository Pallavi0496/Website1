<!-- topbar for website  -->
<nav class="navbar navbar-expand-lg navbar-light bg-light" id=topbar_main>
  <div class="container-fluid">
    <a class="navbar-brand" href="#">Crazy Fun</a>
    ...
    <div class="collapse navbar-collapse row" id="navbarSupportedContent">
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-12">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 justify-content-end">
          <li class="nav-item">
            <a class="nav-link" aria-current="page" data-bs-toggle="modal" data-bs-target="#exampleModal"> <i class="fa fa-user"></i></a>
            <!-- Modal -->
